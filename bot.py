...
BOT_STATUS_NAME = os.getenv('BOT_STATUS_NAME', 'PowerHost')
WATERMARK = os.getenv('WATERMARK', 'Powered by PowerHost VPS Bot')
...
VPS_HOSTNAME = os.getenv('VPS_HOSTNAME', 'PowerHost-free')  # Base hostname, append user ID
...
async def about(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="👨‍💻 Meet the Developer • InsaanXD",
        value=(
            "**InsaanXD** is a passionate **Full-Stack Developer** and **DevOps Enthusiast** from India 🇮🇳\n\n"
            "🔹 **Specialties:**\n"
    ...
    # Social Links
    embed.add_field(
        name="🔗 Connect with InsaanXD",
        value=(
            "📺 **YouTube:** [Watch Tutorials & Guides](https://www.youtube.com/@InsaanXD)\n"
            "💻 **GitHub:** [View Projects & Scripts](https://github.com/InsaanXD)\n"
            "📸 **Instagram:** [Follow for Updates](https://instagram.com/InsaanXD)"
        ),
        inline=False
    )
    ...
    embed.add_field(
        name="🎮 Fun Fact",
        value=(
            "InsaanXD is also a big **Minecraft** fan! Many tutorials cover free/paid hosting, "
    ...
    embed.set_footer(
        text="Built with ❤️ and ☕ by InsaanXD | Thank you for using VPS Manager Bot!",
